...
namespace RenderHeads.Media.AVProVideo.Editor
{
	...
	public class MediaPlayerEditor : UnityEditor.Editor
	{
		...
		{
			public RecentFileData(string path, SerializedProperty propPath, SerializedProperty propLocation, System.Object target)
			{
				this.path = path;
		...
		void RecentMenuCallback_Select(object obj)
		{
			...
			EditorUtility.SetDirty(data.target as UnityEngine.Object);
		}
