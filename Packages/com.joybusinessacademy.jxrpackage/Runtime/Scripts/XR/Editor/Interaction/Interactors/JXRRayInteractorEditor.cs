#if UNITY_EDITOR
using SVR.XRPlayerPackage;
using UnityEditor;
using UnityEngine;
using UnityEngine.XR.Interaction.Toolkit;

namespace JBA.XRPlayerPackage.editor
{
    // COMPLETE REPLICA OF UNITY XR TOOLKIT EDITOR PACKAGE
    // ADDED BOOLEAN INTERACT NEAREST OBJECT ONLY
    [CustomEditor(typeof(SVRRayInteractor)), CanEditMultipleObjects]
