...
namespace GraphProcessor
{
    ...
    /// </summary>
    public class BaseEdgeConnectorListener : IEdgeConnectorListener, IDisposable
    {
		...
		public void Dispose()
		{
			...
			// release edgeNodeCreateMenuWindow so that won't keep useless reference.
			if (null != edgeNodeCreateMenuWindow)
            {
				edgeNodeCreateMenuWindow.Dispose();
				GameObject.DestroyImmediate(edgeNodeCreateMenuWindow);
                edgeNodeCreateMenuWindow = null;
			}
