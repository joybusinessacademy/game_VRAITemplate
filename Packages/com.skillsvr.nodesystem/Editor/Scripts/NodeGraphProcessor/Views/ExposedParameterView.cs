...
{
	public class ExposedParameterView : PinnedElementView, IDisposable
	{
        ...
        protected virtual void UpdateParameterList()
        {
            ...
            {
                BlackboardRow row = new BlackboardRow(new ExposedParameterFieldView(graphView, param), new ExposedParameterPropertyView(graphView, param))
                {
	                expanded = param.settings.expanded
                };
