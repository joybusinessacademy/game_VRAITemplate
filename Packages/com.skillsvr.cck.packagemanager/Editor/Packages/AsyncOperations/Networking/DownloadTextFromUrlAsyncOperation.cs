...
{
    public class DownloadTextFromUrlAsyncOperation : CustomAsyncOperation<string>, IDisposable
    {
        ...
        public DownloadTextFromUrlAsyncOperation(string url, int timeoutInSeconds, params KeyValuePair<string, string>[] headers)
        {
            Url = url;
