...
{
	public class OneClickCC4_CCK : OneClickBase
	{
		/// <summary>
		/// RELEASE NOTES:
		...
		public static void Setup(GameObject gameObject, AudioClip clip)
		{
			...
			NewConfiguration(OneClickConfiguration.ConfigType.Salsa);
			{
				...
				Quaternion offset = Quaternion.Euler(0, -90f, -90f);

				NewExpression("w");
				AddBoneComponent("^CC_Base_JawRoot$",
					new TformBase(new Vector3(-0.01266399f, 0.02537677f, 5.429312E-05f),
					offset * new Quaternion(-5.934526E-05f, 4.134326E-05f, -0.7204347f, 0.6935228f),
				...
				AddBoneComponent("^CC_Base_JawRoot$",
					new TformBase(new Vector3(-0.01266399f, 0.02537677f, 5.429312E-05f),
					offset * new Quaternion(-5.949008E-05f, 4.119518E-05f, -0.7229443f, 0.6909064f) ,
					new Vector3(1f, 1f, 1f)),
					0.11f, 0f, 0.06f,
					"CC_Base_JawRoot",
					false, true, true);
				...
				AddBoneComponent("^CC_Base_JawRoot$",
					new TformBase(new Vector3(-0.01266399f, 0.02537677f, 5.429312E-05f),
					offset * new Quaternion(-5.924235E-05f, 4.159705E-05f, -0.717305f, 0.6967593f),
					new Vector3(1f, 1f, 1f)),
					0.11f, 0f, 0.06f,
					"CC_Base_JawRoot",
					false, true, true);
				...
				AddBoneComponent("^CC_Base_JawRoot$",
					new TformBase(new Vector3(-0.01266399f, 0.02537677f, 5.429312E-05f),
					offset * new Quaternion(-5.964188E-05f, 4.094E-05f, -0.7268888f, 0.6867551f) ,
					new Vector3(1f, 1f, 1f)),
					0.11f, 0f, 0.06f,
					"CC_Base_JawRoot",
					false, true, true);
				...
				AddBoneComponent("^CC_Base_JawRoot$",
					new TformBase(new Vector3(-0.01266399f, 0.02537677f, 5.429312E-05f),
					offset * new Quaternion(-6.123816E-05f, 3.863869E-05f, -0.7511058f, 0.6601818f) ,
					new Vector3(1f, 1f, 1f)),
					0.11f, 0f, 0.06f,
					"CC_Base_JawRoot",
					false, true, true);
				...
				AddBoneComponent("^CC_Base_JawRoot$",
					new TformBase(new Vector3(-0.01266399f, 0.02537677f, 5.429312E-05f),
					offset * new Quaternion(-5.947331E-05f, 4.123336E-05f, -0.7246742f, 0.6890916f),
					new Vector3(1f, 1f, 1f)),
					0.11f, 0f, 0.06f,
					"CC_Base_JawRoot",
					false, true, true);
				...
				AddBoneComponent("^CC_Base_JawRoot$",
					new TformBase(new Vector3(-0.01266399f, 0.02537677f, 5.429312E-05f),
					offset * new Quaternion(-6.339697E-05f, 3.486871E-05f, -0.789081f, 0.6142891f),
					new Vector3(1f, 1f, 1f)),
					0.11f, 0f, 0.06f,
					"CC_Base_JawRoot",
					false, true, true);
