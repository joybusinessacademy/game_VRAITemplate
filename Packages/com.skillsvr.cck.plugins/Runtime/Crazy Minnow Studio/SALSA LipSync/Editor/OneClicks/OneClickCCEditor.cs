...
namespace CrazyMinnow.SALSA.OneClicks
{
	...
	public class OneClickCCEditor : Editor
	{
		...
		[MenuItem("GameObject/Crazy Minnow Studio/SALSA LipSync/One-Clicks/Reallusion/CC4 CCK")]
		public static void OneClickSetup_CCK()
		{
			SalsaOneClickSetup = OneClickCC4_CCK.Setup;
			EyesOneClickSetup = OneClickCC3Eyes.Setup;
