...
namespace I2.Loc
{
	public partial class LanguageSourceData
	{
        ...
        public void UpdateDictionary(bool force = false, bool validateTerms = false)
        {
		...
		public  TermData AddTerm( string NewTerm, eTermType termType, bool SaveSource = true )
		{
			...
			if (data==null) 
			{
				...
				if (data.Term.LastIndexOf('/') != data.Term.Length - 1)
					mTerms.Add (data);
		...
		public void RemoveTerm( string term, bool SaveSource = true)
		{
			for (int i=0, imax=mTerms.Count; i<imax; ++i)
